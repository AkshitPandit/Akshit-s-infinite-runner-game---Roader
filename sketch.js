...
function showText(){
 ...
 textSize(18);
 text("HOLD space TO BOOST & USE arrow keys TO MOVE", 8, 275);
}
...
function movePlayer(){
 ...
 rider.changeAnimation("boost",rider_2Img);
 w1.velocityY = 30;
 ...
 if(keyWentUp("space") || mouseWentUp("leftButton")){
 score = score+ 1;
  var randomNumber =Math.round(random(6,10))
 var car1speed = randomNumber;
 car1.velocityY = car1speed;
 var car2speed = randomNumber;
 car2.velocityY = car2speed;
 var car3speed = randomNumber;
 car3.velocityY = car3speed;
 var car4speed = randomNumber;
 car4.velocityY = car4speed;
 rider.changeAnimation("static",riderImg);
 w1.velocityY = -10;
 w2.velocityY = -10;
 w3.velocityY = -10;
...
edges= createEdgeSprites();
 if(rider.isTouching(car1)||rider.isTouching(car2)||rider.isTouching(car3)||rider.isTouching(car4)||rider.isTouching(edges)){
